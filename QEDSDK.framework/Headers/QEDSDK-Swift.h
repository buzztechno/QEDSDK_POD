...
/// If allowed by the <code>QEDMediaCaptureAndPlayViewControllerDelegate</code>, a user can trigger the deletion of the local stored media file. After deletion the controller will switch to capturing mode automatically.
SWIFT_CLASS("_TtC6QEDSDK36QEDMediaCaptureAndPlayViewController")
@interface QEDMediaCaptureAndPlayViewController : UIViewController
/// :nodoc:
